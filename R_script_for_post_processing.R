...
# 1. Download the sheet "model_details_creator.xlxs" from here: https://github.com/paulvpop/gis-land-cover-mapping/blob/main/model_details_creator.xlsx 
# and upload it to google drive as a google sheet.
