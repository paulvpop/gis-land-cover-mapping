...
```
podman run -it -v "D:\RS_GIS_files\force:/data" davidfrantz/force force-sample-size
```
Output:
```
count-file is missing! _(Ignore this)_ 
...
Set the working directory:
```
setwd("D:/RS_GIS_files/Best_selected_imagery")
```
Load the imagery. 
```
library(terra)
