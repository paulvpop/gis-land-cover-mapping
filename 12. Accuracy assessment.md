...
Once the re-labelling has been done and the final_sample_recoded.kml has been downloaded,
...
training data file in the Sampling section, use the validation data i.e. final_sample_recoded.kml.
This will give you the number of validation points for each classes. 

Now open the final_sample_recoded.kml in Google Earth (Pro) or QGIS (if not already open)
and collect more points for which there are lesser-than-threshold numbers.
