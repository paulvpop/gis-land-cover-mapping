...
This is essentially the final step of the accuracy assessment section if you have all your
processed outputs (from the post-processing section) in one device, or second last step if 
the processed outputs are in multiple devices. 
