...
This will give you the number of validation points for each classes. Open the final_sample_recoded.kml
in Google Earth (Pro) or QGIS and collect more points for which there are lesser-than-threshold
numbers.
