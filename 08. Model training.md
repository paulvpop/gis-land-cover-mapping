...
# Type: full file path
FILE_MODEL = /data/force/third/train_RFC_pbc_one_two_three/MODEL_CLASS_{%SET%}_{%WEIGHT%}.xml
# File for storing the logfile. This file will be overwritten if it exists.
# Type: full file path
FILE_LOG = /data/force/third/train_RFC_pbc_one_two_three/FILE_LOG_{%SET%}_{%WEIGHT%}.log
```
...
Here the -c paired is for ensuring that three models where 00001 corresponds to EQUALIZED, 00002 to PROPORTIONAL, and 00003 to ANTIPROPORTIONAL, are created, and not 9 models where every number is matched with every class weight names.
