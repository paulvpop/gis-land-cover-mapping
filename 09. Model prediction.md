...
If you have run prediction for multiple models at the same time, you should use the following R Script for extraction of individual model bands from combined multi-band rasters
