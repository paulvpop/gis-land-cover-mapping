...
*IMPORTANT:* The C drive where the terra package will create a temporary folder for putting temporary objects need
have a good amount of free space, ideally at least 50 GB of free space just to be on the safer side. Increase the 
free space even further if you're processing hundreds or thousands of models at the same time.  Without the free 
...
# entire commented out chunk of code commepress ctrl+shift+C:
